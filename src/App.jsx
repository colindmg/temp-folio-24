...
function App() {
  return (
    <>
      <div className="relative text-white h-screen w-screen bg-[#141414] flex flex-col justify-between p-24">
        <div className="z-50">
        ...
        <div className="z-50 flex flex-col gap-1 font-grotesk text-xl">
